                ...
                <div>
                    ...
                    <img className={styles.img} src={imgZones} alt="Game Zones" />
                        ...
                        <ol>
                            ...
                            <li><b>Valid Moves:</b>
                            <ul>
                                <li>Click on your card to see available actions, after that, choose the amount of dices it costs and click on the ability you want to use. Skill2 can be performed only with specific symbol dice but skill1 can be used with any dice.</li>
